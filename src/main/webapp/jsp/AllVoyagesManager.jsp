...
<div id="navbar">
    <ul>
        ...
        <li><a class="a" href="#">Caps</a></li>
        <li><a class="a" href="AllVoyagesServlet" >Ships</a></li>
    </ul>
</div>
<div>
    <div class="button login">
        <button onclick="window.location.href = 'http://localhost:8080/PortWebApp/html/AddShip.html';" style="background-color: white"><span>Add new ship</span> <i class="fa fa-check"></i></button>
    </div>
    <table class="table">
        <tr>
            <th width="5%%">ID</th>
