...
<div style="height: 100%; overflow:auto;">
    ...
    <div>
        <div class="button login">
            <button onclick="window.location.href = 'http://localhost:8080/PortWebApp/AddCapServlet';"
                    style="background-color: white"><span>Add new cap</span> <i class="fa fa-check"></i></button>
        </div>
