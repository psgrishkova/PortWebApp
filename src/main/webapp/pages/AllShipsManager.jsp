...
<div style="height: 100%; overflow:auto;">
    ...
    <div style="margin-bottom: 30px">
        <div class="button login">
            <button onclick="window.location.href = 'http://localhost:8080/PortWebApp/AddShipServlet';"
                    style="background-color: white"><span>Add new ship</span> <i class="fa fa-check"></i></button>
        </div>
